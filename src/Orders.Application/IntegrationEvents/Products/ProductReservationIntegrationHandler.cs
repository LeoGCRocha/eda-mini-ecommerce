...
public class ProductReservationIntegrationHandler : IRequestHandler<ProductReservationIntegration>
{
    ...
    public async Task Handle(ProductReservationIntegration request, CancellationToken cancellationToken)
    {
        ...
        // respeitam uma ordem.
        // Esta é a primeira etapa pro controle de concorrência em um inventario para garantir que diferentes consumidores (exemplo replicas dessa app)
        // Não recebam produtos de mesmo id oque traria condição de corrida pro anco de dados.
