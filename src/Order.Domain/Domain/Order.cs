...
using Order.Domain.Domain.Events;
using Order.Domain.Domain.Exceptions;

namespace Order.Domain.Domain;

// todo: VER SOBRE WEB APP NA AZURE
// TODO: Ver sobre resolução de problemas em controle de ESTOQUE....
